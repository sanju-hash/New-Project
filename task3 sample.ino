const int SIGNAL_PIN = 3; // the pin connected to the signal
const int MEASURE_INTERVAL = 8; // in milliseconds
const int SAMPLES = 10; // the number of signal edges to count
const float MIN_FREQUENCY = 500; // in Hz
const float MAX_FREQUENCY = 1000; // in Hz
const float ACCEPTABLE_ERROR = 0.025; // 2.5% error
const int PERIOD = 8000; // in microseconds
const int RATE = 125; // in Hz
